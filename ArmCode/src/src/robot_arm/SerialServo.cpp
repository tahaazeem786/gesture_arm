...
// Parse received data packet information and return
...
int BusServo_t::ReadID(void)
{
  ...
  buf[0] = buf[1] = LOBOT_SERVO_FRAME_HEADER;
  buf[2] = ID_ALL;  // ID_ALL is 254; broadcasts to all servos (useful for reading servos with unknown IDs)
  buf[3] = 3;
