...
void setup() {
  ...
  Serial.println("  <id> <pos>      e.g. 1 800   (pos 0..1000)");
  Serial.println("  t <ms>          e.g. t 1000");
  Serial.println("  reset           center all servos (multi packet)");
  Serial.println("  reset_seq       center all servos (one-by-one)");
}
